...
import com.shopcloud.order.dto.ErrorResponse;
...
/**
 * Bệ đỡ lỗi toàn cục (Global Exception Handler) tập trung cho dịch vụ đơn hàng (order-service).
 * <p>
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGlobalException(
        ...
        log.error("[Order-Service Error] Sự cố hệ thống chưa lường trước tại URI [{}]: ", request.getRequestURI(), ex);
