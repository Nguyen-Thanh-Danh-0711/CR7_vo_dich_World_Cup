...
import com.shopcloud.product.dto.ErrorResponse;
...
/**
 * Bệ đỡ lỗi toàn cục (Global Exception Handler) tập trung cho dịch vụ sản phẩm (product-service).
 * <p>
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGlobalException(
        ...
        log.error("[Product-Service Error] Sự cố hệ thống chưa lường trước tại URI [{}]: ", request.getRequestURI(), ex);
